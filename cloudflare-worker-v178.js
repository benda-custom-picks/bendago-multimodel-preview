...
// Version: V178 Café Holder 125/250 + Ghost Metal Cover 125/250 in Blackout Predator (aviation-grade aluminium product copy)
...
const DEFAULT_SUCCESS_URL = 'https://bendacustompicks.com/cart-request.html?payment=stripe_success&session_id={CHECKOUT_SESSION_ID}';
const DEFAULT_CANCEL_URL = 'https://bendacustompicks.com/cart-request.html?payment=stripe_cancelled';
...
async function createStripeCheckout(request, env, cors) {
  ...
  const successUrl = env.SUCCESS_URL || DEFAULT_SUCCESS_URL;
  const cancelUrl = env.CANCEL_URL || DEFAULT_CANCEL_URL;
